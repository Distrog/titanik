...
public class PassengerController {
    ...
    @GetMapping
    ResponseEntity<PassengerResponse> getAllPassengers
    ...
    ResponseEntity<PassengerResponse> getAllPassengersOrderByAscByName
            (@RequestParam(name = "page-number", defaultValue = "1") Integer pageNumber,
             @RequestParam(name = "page-size", defaultValue = "50") Integer pageSize) {
    ...
    ResponseEntity<PassengerResponse> getAllPassengersOrderByDescByName
            (@RequestParam(name = "page-number", defaultValue = "1") Integer pageNumber,
             @RequestParam(name = "page-size", defaultValue = "50") Integer pageSize) {
    ...
    ResponseEntity<PassengerResponse> getAllPassengersOrderByAscByAge
            (@RequestParam(name = "page-number", defaultValue = "1") Integer pageNumber,
             @RequestParam(name = "page-size", defaultValue = "50") Integer pageSize) {
    ...
    ResponseEntity<PassengerResponse> getAllPassengersOrderByDescByAge
            (@RequestParam(name = "page-number", defaultValue = "1") Integer pageNumber,
             @RequestParam(name = "page-size", defaultValue = "50") Integer pageSize) {
    ...
    ResponseEntity<PassengerResponse> getAllPassengersOrderByAscByFare
            (@RequestParam(name = "page-number", defaultValue = "1") Integer pageNumber,
             @RequestParam(name = "page-size", defaultValue = "50") Integer pageSize) {
    ...
    ResponseEntity<PassengerResponse> getAllPassengersOrderByDescByFare
            (@RequestParam(name = "page-number", defaultValue = "1") Integer pageNumber,
             @RequestParam(name = "page-size", defaultValue = "50") Integer pageSize) {
    ...
    ResponseEntity<PassengerResponse> findPassengersByName
